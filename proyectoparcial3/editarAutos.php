...
<body>
	<?php 
		...
		$sql = "SELECT * FROM autos WHERE id=$id_auto LIMIT 1";
			...
			<div class="col-md-6 col-md-offset-3">
				<form action="update.php" method="POST">
					...
					<div class="form-group">
						...
						<input type="text" name="modelo" class="form-control" value="<?php echo $auto->modelo; ?>">
					</div>
					<div class="form-group">
						<label for="">Hp</label>
						<input type="text" name="hp" class="form-control" value="<?php echo $auto->hp; ?>">
					</div>
					<div class="form-group">
						<label for="Precio">Precio</label>
						<input type="text" name="precio" class="form-control" value="<?php echo $auto->precio; ?>">
					</div>
